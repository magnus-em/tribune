...
const STEPS = [
  ...
  { label: "Landlord", description: "Who to send the demand to" },
  { label: "Deposit", description: "Amounts and agreement" },
];

// Per-step schemas for validation (plain objects, no cross-field refine)
const stepSchemas = [
  // Step 0
  // Step 0: Your Info
  z.object({
  ...
  // Step 1: Property — with date cross-validation
  z
    .object({
  ...
  z.object({
    ...
    landlord_email: z.string(),
    landlord_phone: z.string(),
    landlord_address: z.string(),
  }),
  // Step 3: Deposit — with amount validation
  z
    .object({
        ...
        <CardContent>
          ...
          {step === 0 && (
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="forwarding_address">
                  Current / Forwarding Address
                </Label>
                <Input
                  id="forwarding_address"
                  {...register("forwarding_address")}
                />
                <FieldError message={errors.forwarding_address?.message} />
                <p className="text-xs text-muted-foreground">
                  CT law requires your landlord to have your forwarding address
                  to calculate their legal deadline.
                </p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="landlord_address">
                  Landlord Mailing Address (if known)
                </Label>
                <Input
                  id="landlord_address"
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label
                  htmlFor="itemized_deductions_received"
                  className="text-sm"
                >
              ...
              <div className="space-y-1.5">
                <Label htmlFor="situation_description">
              ...
              <div className="border rounded-lg p-4 bg-muted/50 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Tribune charges a {CONTINGENCY_PCT}% contingency fee on any
                  amount recovered. If we don&apos;t recover anything, you owe
                  nothing.
                </p>
                <div className="flex items-start space-x-2">
                  ...
                  />
                  <Label
                    htmlFor="contingency_agreed"
                    className="text-sm leading-relaxed"
                  >
                    I agree that if Tribune helps recover any portion of my
                    security deposit, I will pay {CONTINGENCY_PCT}% of the
                    recovered amount. If nothing is recovered, I owe nothing.
                  </Label>
                </div>
